          ...
          <div>
              ...
              <div className="before:-lef-20 before:absolute before:-top-20 before:z-[-1] before:content-abstractwaves">
                ...
                >
                  <HText>
                    ...
                    <span className="text-primary-500">ALMA</span>
                  </HText>
                </motion.div>
              </div>
            </div>
            ...
            >
              <p className="my-5">
                ...
                eaque nesciunt fuga praesentium nisi officia iure enim aliquid
                dolorem dicta eius, vero perferendis atque rerum blanditiis ab.
                Quam, natus illum!
              </p>
              <p className="mb-5">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias
